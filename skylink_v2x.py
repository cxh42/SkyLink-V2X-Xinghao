...
from skylink_v2x.scenario_manager.scenario_runner import run_scenario

# from skylink_v2x.version import __version__


def arg_parse():
    # create an argument parser
    parser = argparse.ArgumentParser(description="Skylink V2X scenario runner.")
    ...
    parser.add_argument('-t', "--test_scenario", required=True, type=str,
                        help='Define the name of the scenario you want to test. The given name must'
                             ...
                             'skylink_v2x/scenario_testing/ folder'
                             ' as well as the corresponding yaml file in skylink_v2x/scenario_testing/config_yaml.')
...
def main():
    ...
    #     "skylink_v2x.scenario_testing.%s" % opt.test_scenario)
    # check if the yaml file for the specific testing scenario exists
    if not os.path.isfile(config_yaml):
        sys.exit(
            "skylink_v2x/skylink_configs/%s.yaml not found!" % opt.test_cenario)
